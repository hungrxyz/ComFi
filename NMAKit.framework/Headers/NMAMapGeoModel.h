...
/**
 * \class NMAMapGeoModel NMAMapGeoModel.h "NMAMapGeoModel.h"
 *
 * \brief A 3D model defined as an array of geographical coordinates that can be
 ...
 */
- (id)initWithMesh:(NMAGeoMesh *)mesh;
