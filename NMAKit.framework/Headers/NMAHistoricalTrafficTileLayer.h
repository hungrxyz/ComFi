...
/**
 * \class NMAHistoricalTrafficTileLayer NMAHistoricalTrafficTileLayer.h "NMAHistoricalTrafficTileLayer.h"
 *
...
/**
 * \brief Initializes a historical traffic tile layer for a specific day,
 * hour and minute.
 *
 ...
 *
 * \note If any of the input parameters are invalid, this method will return nil.
 *
 * \note Calling the default [NMAHistoricalTrafficTileLayer init] method will call
 * this method with the current local day/hour/minute values.
 */
- (instancetype)initForWeekDay:(NSInteger)weekDay hour:(NSInteger)hour minute:(NSInteger)minute;
