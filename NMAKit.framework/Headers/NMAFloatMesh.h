...
/**
 * \class NMAFloatMesh NMAFloatMesh.h "NMAFloatMesh.h"
 *
...
/**
 * \brief Convenient initializer for creating a NMAFloatMesh with required geometry data
 *
