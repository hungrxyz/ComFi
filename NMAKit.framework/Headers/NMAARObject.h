...
/**
 * \class NMAARObject NMAARObject.h "NMAARObject.h"
 *
 * \brief Base class for all LiveSight objects that can be added to an NMAARController.
 *
 * This class serves as a generalization (or abstract base) for more specific
 * object types (such as {@link NMAARIconObject}), bundling their common properties.
 ...
 */
@property (nonatomic) NMAGeoCoordinates *coordinates;
...
/**
 * The projection type used to display the {@link NMAARObject} in a camera view.
 *
 ...
 *
 * \note Attempts to replace an existing NMAImage with nil will be ignored.
 */
@property (nonatomic, readwrite) NMAImage *frontPlaneIcon;
 ...
 * \note Attempts to replace an existing NMAImage with nil will be ignored.
 */
@property (nonatomic, readwrite) NMAImage *backPlaneIcon;


#pragma mark - Object Info Image
 ...
 * \note Attempts to replace an existing NMAImage with nil will be ignored.
 */
@property (strong, nonatomic) NMAImage *infoImage;
