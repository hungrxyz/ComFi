...
/**
 * \class NMAMapLocalModel NMAMapLocalModel.h "NMAMapLocalModel.h"
 *
 * \brief Displays a custom 3D model at a fixed geographical location on a map.
 *
 ...
 *
 * \note The mesh parameter cannot be nil.
 */
- (id)initWithMesh:(NMAFloatMesh *)mesh;
