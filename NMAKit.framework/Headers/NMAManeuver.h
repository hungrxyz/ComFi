...
typedef NS_ENUM(NSInteger, NMAManeuverAction) {
    ...
    /** \brief An action that indicates heading after leaving public transit station. */
    NMAManeuverActionHeadTo,                    // 15
    /** \brief An action that indicates passing a station. */
    NMAManeuverActionPassStation,               // 16
    /** \brief An action that indicates transit line change. */
...
typedef NS_ENUM(NSUInteger, NMAManeuverIcon) {
    ...
    /** \brief An icon that indicates passing a station. */
    NMAManeuverIconPassStation,             // 46

    /** \brief An icon that indicates heading after leaving public transit station. */
    NMAManeuverIconHeadTo,                  // 47
    /** \brief An icon that indicates transit line change. */
 ...
 * \note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak) NSString *nextRoadName;
 ...
 * \note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak) NSString *roadNumber;
 ...
 * \note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak) NSString *nextRoadNumber;
 ...
 */
@property (nonatomic, readonly, weak) NSDate *startTime;
 ...
 *
 */
@property (nonatomic, readonly) NSArray *maneuverGeometry;
 ...
 */
@property (nonatomic, readonly) NMAImage *nextRoadIcon;
 ...
 */
@property (nonatomic, readonly) NMASignpost *signpost;
 ...
 */
@property (nonatomic, readonly) NSArray *routeElements;
