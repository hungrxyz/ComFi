...
/**
 * \brief The interface used to create a automotive position source for NMAPositioningManager.
 *
 ...
 *
 * \note Setting a source derived from this class will force NMAPositioningManager to use a
 ...
 *
 * \note Attempts to set [NMAPositioningManager dataSource] to an object derived from
...
/**
 * \brief Horizontal radial error (large component) as a standard deviation in meters.
 */
- (float)horizontalLargeStandardDeviation;

/**
 * \brief Horizontal radial error (small component) as a standard deviation in meters.
 */
- (float)horizontalSmallStandardDeviation;

/**
 * \brief Standard deviation of the course in degrees.
 */
- (float)courseStandardDeviation;

/**
 * \brief Standard deviation of the speed meters per second.
 */
- (float)speedStandardDeviation;

/**
 * \brief Standard deviation of the elevation in meters.
 */
