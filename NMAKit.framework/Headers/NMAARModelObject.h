...
typedef NS_ENUM(NSUInteger, NMAARModelObjectShadingMode) {
    /**
     * \brief Textured without lighting.
     */
    NMAARModelObjectShadingModeFlatTextured = 0,

    /**
     * \brief Textured with diffuse lighting.
     */
...
/**
 * \class NMAARModelObject NMAARModelObject.h "NMAARModelObject.h"
 *
 * \brief The base class for all LiveSight 3D objects that users can add to an
 * {@link NMAARController}.
 *
 ...
 */
@property (nonatomic, readwrite) NMAImage *texture;
 ...
 * distance.
 *
 * \sa NMAARModelObject::dynamicScaleRange
 */
