...
/**
 * \class NMAMapTileRequest NMAMapTileRequest.h "NMAMapTileRequest.h"
 *
 * \brief Represents a request for tile bitmap data.
 *
...
/**
 * \brief Returns a memory buffer for you to copy bitmap data into.
 *
 ...
 * data.
 */
@property (nonatomic, readonly) void *bytesPtr;
...
/**
 * \brief NMAMapTileRequest status.
 *
...
/**
 * \brief Copies tile bitmap data from an NSData instance to the bytesPtr property.
 *
